...
void test_mode_enum_values(void) {
    ...
    TEST_ASSERT_EQUAL_UINT8(0x02, MODE_TRACKER);
    TEST_ASSERT_EQUAL_UINT8(0x03, MODE_ASTRO);
    TEST_ASSERT_EQUAL_UINT8(0x04, MODE_DARK_FRAME);
    TEST_ASSERT_EQUAL_UINT8(0x05, MODE_RAMP);
